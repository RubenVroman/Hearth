...
- Destructive tools (HA writes, *arr/Overseerr add, Thuisbezorgd order, file delete, docker stop,
  chief_of_staff) default to dry-run. Ask {settings.owner} to confirm, then call again with
  confirm=true. A voice or UI confirm is enough. Never place a paid food order without confirm.
