...
MOCK_PLEX_LIBRARY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contentRating": "NR",
        "audienceRating": 6.5,
        "Genre": [{"tag": "Horror"}, {"tag": "Mystery"}, {"tag": "Science Fiction"}],
    ...
    # Two exact-title editions so ambiguous library matches can be tested.
    {
        ...
        "contentRating": "R",
        "audienceRating": 8.3,
        "Genre": [{"tag": "Crime"}, {"tag": "Drama"}, {"tag": "Action"}],
        "Guid": [{"id": "tmdb://949"}],
        "tmdbId": 949,
    ...
    },
    {
        ...
        "contentRating": "R",
        "audienceRating": 5.7,
        "Genre": [{"tag": "Action"}, {"tag": "Crime"}, {"tag": "Drama"}],
        "Guid": [{"id": "tmdb://10784"}],
        "tmdbId": 10784,
    ...
    },
    {
        ...
        "contentRating": "PG",
        "audienceRating": 8.6,
        "Genre": [{"tag": "Animation"}, {"tag": "Family"}, {"tag": "Fantasy"}],
        "Guid": [{"id": "tmdb://129"}, {"id": "imdb://tt0245429"}],
        "tmdbId": 129,
        "posterPath": "/39wmItkWPnB72Ny0ry39EiOlf7p.jpg",
    },
    {
        "title": "Toy Story",
        "type": "movie",
        ...
        "contentRating": "G",
        "audienceRating": 8.3,
        "Genre": [{"tag": "Animation"}, {"tag": "Comedy"}, {"tag": "Family"}],
        "Guid": [{"id": "tmdb://862"}, {"id": "imdb://tt0114709"}],
        "tmdbId": 862,
    ...
    },
    {
        ...
        "guid": "plex://movie/howls-moving-castle",
        "summary": "When an unconfident young woman is cursed with an aging spell, a self-confident yet anti-social young wizard helps her find her way.",
        "contentRating": "PG",
        "audienceRating": 8.2,
        "Genre": [{"tag": "Animation"}, {"tag": "Fantasy"}, {"tag": "Adventure"}],
        "Guid": [{"id": "tmdb://4935"}, {"id": "imdb://tt0347149"}],
        "tmdbId": 4935,
...
MOCK_OVERSEERR_RESULTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "year": 2018,
        "overview": "A biologist enters the Shimmer after her husband's return.",
        "posterPath": "/d5Kt1iZGm01lGD39kIOMteNLa17.jpg",
    },
    {
        "id": 974950,
        "mediaType": "movie",
    ...
    },
    {
        ...
        "year": 2022,
        "overview": "Misfit spies at MI5's Slough House.",
        "posterPath": "/g4yJThNVePYHELth7CycCqvLmwR.jpg",
    },
    {
        "id": 241001,
        "mediaType": "tv",
