    ...
    registry.register(
        ToolSpec(
            ...
            description=(
                ...
                "time left, status, quality/indexer). Use for “download progress for X”, "
                ...
                "If the title is not downloading, reports library status (completed / missing) "
                "or that it is not in Radarr — say that; do not escalate to Chief of Staff."
            ),
            parameters={
                "type": "object",
                "properties": {
